export const animalEyesOptions = {
  "sparkle-eyes": (_color: string) => `
...
export const animalEyesKeys = Object.keys(animalEyesOptions) as Array<
  keyof typeof animalEyesOptions
>;

export const animalEyesViewPort = "137 218 226 69";
